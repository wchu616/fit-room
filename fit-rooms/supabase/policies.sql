...
-- Storage policies
create policy "Allow authenticated users to upload their checkins"
...
create policy "Allow authenticated users to delete their checkins"
...
create policy "Allow authenticated users to read their checkins"
